...
export const SITE_DOM_COSMETIC_FILTER_APPLIED = 'SITE_DOM_COSMETIC_FILTER_APPLIED'
export const SITE_CSS_COSMETIC_FILTER_APPLIED = 'SITE_CSS_COSMETIC_FILTER_APPLIED'
export const SITE_LOGGED_STORAGE = 'SITE_LOGGED_STORAGE'
